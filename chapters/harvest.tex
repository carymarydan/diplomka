...
\end{lstlisting}
Odpovìd ve formátu XML obsahuje maximálnì 30 záznamù. Na konci tohoto souboru je obvykle tag \texttt{<resumptionToken>}, ve kterém je udán øetìzec, podle kterého se dalším dotazem na OAI-PMH získá pokraèování seznamu identifikátorù se zmìnìnými údaji. Tento dotaz vypadá takto:
\begin{lstlisting}
