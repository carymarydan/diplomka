...
V Národní technické knihovnì konkrétní požadavkem na sklízení dat pøes protokol OAI-PMH vypadá takto:
\begin{lstlisting}
http://aleph.techlib.cz/OAI?verb=ListIdentifiers&from=2016-07-06&metadataPrefix=marc21&set=NTK
\end{lstlisting}
Odpovìd ve formátu XML obsahuje 30 záznamù. Na konci tohoto souboru je obvykle tag \texttt{<resumptionToken>}, ve kterém je udán øetìzec, podle kterého se dalším dotazem na OAI-PMH získá pokraèování seznamu identifikátorù se zmìnìnými údaji. Tento dotaz vypadá takto:
\begin{lstlisting}
