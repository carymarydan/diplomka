...
Užiteèným souborem pøi importu dat do VuFindu je bezpochyby \texttt{solrmarc.log}, kam se zapisují veškeré provedené akce s tímto spojené a je tedy nepostradatelný pøi ladìní chyb. V pøípadech, kdy se nìjaký záznam do indexu nedostane, zapíše se do tohoto souboru error.
\cite{vufind.import}
