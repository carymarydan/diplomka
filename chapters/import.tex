...
\end{verbatim}
Dále je vytvoøen zcela nový indexaèní skript \texttt{stripSlashEnd.bsh} speciálnì pro potøeby NTK. Ten zpracovává MARCová pole 245a a 245b obsahující název a podnázev daného záznamu. Konkrétnì jde o oøíznutí posledního znaku tìchto øetìzcù, je-li jím znak lomítka \uv{/}. Zdrojový kód skriptu vypadá takto:
\begin{lstlisting}
