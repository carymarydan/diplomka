...
Obálky knih, jež se v katalogu NTK zobrazují, se získávají buï pøímo v knihovnì pøi skenování, a nebo se získávají z portálu ObalkyKnih.cz. Získávání obálek v poøadí, kdy se nejprve zjistí, zda je obálka na lokálním serveru, popøípadì se dále hledá na serveru Obalkyknih.cz,  zajišuje logika, jejíž souèástí je v objektovì orientovaném PHP novì naprogramovaná tøída \texttt{AlephImageCovers}, která  hledá obálky na lokálním serveru Aleph a vypadá takto:
\begin{lstlisting}
