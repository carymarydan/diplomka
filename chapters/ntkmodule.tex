...
Obálky knih, které se v katalogu NTK zobrazují, se získávají buï pøímo v knihovnì pøi skenování, nebo samozøejmì v dnešní dobì vznikají již elektronicky, a nebo se získávají z portálu ObalkyKnih.cz. Aby tato logika fungovala v tomto poøadí, tedy zjistit, zda je obálka na lokálním serveru knihovny, popøípadì ji potom hledat na serveru Obalkyknih.cz je v objektovì orientovaném PHP naprogramována nová tøída \texttt{AlephImageCovers}, která vypadá takto:
\begin{lstlisting}
