...
\end{verbatim}
a pøedají se mu jako parametry identifikátory zobrazených záznamù. S tìmito id záznamù se potom vytvoøí jednotlivé HTTP požadavky na informace o dostupnosti a umístìní tìchto záznamù do Alephu. Ten vrátí XML odpovìdi, v nichž požadované informace jsou zakódovány. Výše zmínìný soubor kódy dešifruje a pøiøadí jim èitelné øetìzce, které se následnì zobrazí mezi výsledky. Ukázka èásti zdrojového kódu spravující tuto problematiku typickou pro lokální prostøedí je:
\begin{lstlisting}
