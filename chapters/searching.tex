\label{sec:searching}
V Národní technické knihovnì je vyhledávání rozšíøeno o vyhledávání podle systémového èísla. Systémové èíslo je unikátním identifikátorem záznamù v tomto knihovním systému. Skládá se z devíti-ciferného èísla. Rozsah devíti-ciferných èísel pøesahuje poèet záznamù v katalogu, proto toto èíslo zpravidla obsahuje zleva nuly. Aby nebylo nutné manuálnì do vyhledávacího pole tyto doplòující nuly zadávat, je vytvoøena èást zdrojového kódu, která toto upravuje. Doplòování vyhledávacího øetìzce zleva nulami na devíti-ciferné èíslo pøi vyhledávání podle systémového èísla tak probíhá automaticky. Není tedy nutné zadávat celý identifikátor, nýbrž staèí pouze jeho nenulová èást. Pøíklad je uveden zde:
\begin{verbatim}
000020060 -> 20060
\end{verbatim}
...
Další úpravou zdrojového kódu je v pokroèilém vyhledávání nastaven výchozí stav tøí vyhledávacích polí na prohledávání v poli \textit{název}, \textit{autor} a ve \textit{všech polích}. To probíhá v souboru:
\begin{verbatim}
...
na uvodni strane øazení faset frekvenènì.